...
set_property -dict [list CONFIG.ALL_PARAMS {HAS_AXI_LITE_IF 1 RESET_ACTIVE_LEVEL 0 CP_FIFO_DEPTH 32 CP_FIFO_TYPE lutram CDC_STAGES 2 VS {rp_shift {ID 0 NAME rp_shift RM {left {ID 0 NAME left BS {0 {ID 0 ADDR 83886080 SIZE 693472 CLEAR 0}}} right {ID 1 NAME right BS {0 {ID 0 ADDR 100663296 SIZE 693472 CLEAR 0}}} b_led {ID 2 NAME b_led BS {0 {ID 0 ADDR 117440512 SIZE 693472 CLEAR 0}}}} POR_RM left RMS_ALLOCATED 4 NUM_TRIGGERS_ALLOCATED 4}} CP_FAMILY ultrascale_plus DIRTY 2} CONFIG.GUI_VS_NUM_TRIGGERS_ALLOCATED {4} CONFIG.GUI_SELECT_RM {2} CONFIG.GUI_RM_NEW_NAME {b_led} CONFIG.GUI_BS_ADDRESS_0 {0x7000000} CONFIG.GUI_BS_SIZE_0 {693472}] [get_bd_cells prc_0]
...
#awprot
add_files -norecurse C:/Users/khazi/Documents/Master_Thesis/prc_lab_usp-2018.3_awprot/Sources/Static/awprot.vhd
update_compile_order -fileset sources_1
