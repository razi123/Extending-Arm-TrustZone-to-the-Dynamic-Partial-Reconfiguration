...
set_property -dict [list CONFIG.ALL_PARAMS {HAS_AXI_LITE_IF 1 RESET_ACTIVE_LEVEL 0 CP_FIFO_DEPTH 32 CP_FIFO_TYPE lutram CDC_STAGES 6 VS {rp_shift_03 {ID 0 NAME rp_shift_03 RM {left_03 {ID 0 NAME left_03 BS {0 {ID 0 ADDR 83886080 SIZE 693472 CLEAR 0}}} right_03 {ID 1 NAME right_03 BS {0 {ID 0 ADDR 100663296 SIZE 693472 CLEAR 0}}} bled_03 {ID 2 NAME bled_03 BS {0 {ID 0 ADDR 117440512 SIZE 693472 CLEAR 0}}}} POR_RM left_03 NUM_TRIGGERS_ALLOCATED 4} rp_shift_47 {ID 1 NAME rp_shift_47 RM {left_47 {ID 0 NAME left_47 BS {0 {ID 0 ADDR 134217728 SIZE 693472 CLEAR 0}}} right_47 {ID 1 NAME right_47 BS {0 {ID 0 ADDR 134911228 SIZE 693472 CLEAR 0}}} bled_47 {ID 2 NAME bled_47 BS {0 {ID 0 ADDR 150994944 SIZE 693472 CLEAR 0}}}} NUM_TRIGGERS_ALLOCATED 4}} CP_FAMILY ultrascale_plus DIRTY 2} CONFIG.GUI_SELECT_VS {1} CONFIG.GUI_VS_NEW_NAME {rp_shift_47} CONFIG.GUI_VS_NUM_TRIGGERS_ALLOCATED {4} CONFIG.GUI_VS_NUM_RMS_ALLOCATED {4} CONFIG.GUI_VS_POR_RM {0} CONFIG.GUI_SELECT_RM {2} CONFIG.GUI_RM_NEW_NAME {bled_47} CONFIG.GUI_BS_ADDRESS_0 {0x9000000} CONFIG.GUI_BS_SIZE_0 {693472} CONFIG.GUI_SELECT_TRIGGER_0 {0} CONFIG.GUI_SELECT_TRIGGER_1 {1} CONFIG.GUI_SELECT_TRIGGER_2 {2} CONFIG.GUI_SELECT_TRIGGER_3 {0}] [get_bd_cells prc_0]
...
copy_bd_objs /  [get_bd_cells {logic_1}]

connect_bd_net [get_bd_pins logic_1/dout] [get_bd_pins prc_0/vsm_rp_shift_03_rm_shutdown_ack]
connect_bd_net [get_bd_pins logic_2/dout] [get_bd_pins prc_0/vsm_rp_shift_47_rm_shutdown_ack]
...
#awprot
add_files -norecurse C:/projects/Master_Thesis/AWPORT_8LEDs/Sources/Static/awprot.vhd
update_compile_order -fileset sources_1
...
import_files -norecurse {./Sources/Static/rp_led.v ./Sources/Static/rp_led2.v ./Sources/Static/led_control.v ./Sources/Static/top.v}
update_compile_order -fileset sources_1
